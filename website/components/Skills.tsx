...
const Skills = () => {
    return (
        <div id='skills' className='snap-start w-full md:h-screen p-2 flex items-center py-16'>
            <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8 px-2'>
                <div className='col-span-2'>
                    <p className='uppercase text-xl tracking-widest accent'>Skills</p>
                ...
                <div className='w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-100'>
                    {/* Use Lazy Loading */}
                    {/* <img src="" alt="" /> */}
                    <Image className='rounded-xl' src="/../public/assets/me.png" alt="/" width={300} height={50} />
                </div>
            </div>
        </div>
    )
